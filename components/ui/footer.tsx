        ...
        <div className="mb-4 md:mb-0">
          <div className="shrink-0 flex flex-col md:flex-row items-center">
            ...
            <div className="text-sm text-slate-500 ml-4">
              Copyright © zkSynth<span className="md:hidden lg:inline">. All rights reserved.</span>
            </div>
          </div>
        </div>
        {/* Social links */}
        <ul className="inline-flex space-x-2">
          <li>
            <a
              ...
              href="https://twitter.com/zkSynth"
              aria-label="Twitter"
            >
          ...
          <li>
            <a
              className="flex justify-center items-center text-blue-500 hover:text-blue-600 transition duration-150 ease-in-out"
              href="http://discord.gg/DcVSvsdDHy"
              aria-label="Telegram"
            >
              <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
